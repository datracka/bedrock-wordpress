...
<table class="shop_table cart" cellspacing="0">
	...
	<tbody>
		...
		<div class="krown-column-row wooc clearfix" style="padding-top:0">

			<div class="krown-column-container span6 clearfix" style="padding-right:40px">

			<?php if ( WC()->cart->coupons_enabled() ) { ?>

				<h3><?php _e('Apply Coupon', 'krown'); ?></h3>
				<div class="coupon clearfix">

					<input name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Coupon code', 'krown' ); ?>" /> <input type="submit" class="button" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'krown' ); ?>" />
			...
			<div class="krown-column-container span6 clearfix" style="padding-left:40px">
				...
				<?php woocommerce_cart_totals(); ?>
 				...
 				<input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e( 'Proceed to Checkout', 'krown' ); ?>" />
				<input type="submit" class="button" name="update_cart" value="<?php _e( 'Update Cart', 'krown' ); ?>" />
