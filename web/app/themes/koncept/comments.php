	...
	<?php endif; ?>
		...
		<?php 
			...
			$defaults = array( 'fields' => apply_filters( 'comment_form_default_fields', array(
				...
				'comment_field' => '<div class="krown-column-container span12 last" style="margin-left:0"><label for="comment">' . __('Comment *', 'krown') . '</span></label><textarea id="comment" name="comment" rows="8"></textarea></div>',
