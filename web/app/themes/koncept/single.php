...
get_header(); ?>
	...
	<nav class="post-nav">
		...
		if ( ! empty( $prev_post ) ) : ?>
			<a class="btn-prev" href="<?php echo $prev_post->guid; ?>"><?php echo krown_svg( 'arrow_left' ); ?></a>
		<?php endif; ?>
		...
		<?php if ( ! empty( $next_post ) ) : ?>
			<a class="btn-next" href="<?php echo $next_post->guid; ?>"><?php echo krown_svg( 'arrow_right' ); ?></a>
		<?php endif; ?>
